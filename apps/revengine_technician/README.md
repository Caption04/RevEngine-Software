# Rev Engine Technician App

This is the isolated Flutter scaffold for the native Rev Engine technician app.
It lives under `apps/revengine_technician` so backend changes and mobile changes stay separate.
