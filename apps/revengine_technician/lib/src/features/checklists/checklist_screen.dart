        ...
        child: SafeArea(
          child: ListView(
            ...
            children: <Widget>[
              ...
              PremiumCard(
                glowColor: RevEnginePalette.primaryBright,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        const PremiumIconTile(icon: Icons.checklist, color: RevEnginePalette.primaryBright),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              const Text('Complete the on-site quality checks.', style: TextStyle(color: RevEnginePalette.muted)),
                            ],
                          ),
                        ),
                      ],
              ...
              ..._answers.map(
                (answer) => Padding(
                  ...
                  child: PremiumCard(
                    ...
                    glowColor: answer.checked ? RevEnginePalette.success : null,
                    child: CheckboxListTile(
                      value: answer.checked,
                      contentPadding: EdgeInsets.zero,
                      controlAffinity: ListTileControlAffinity.leading,
                      activeColor: RevEnginePalette.success,
                      title: Text(answer.label, style: const TextStyle(fontWeight: FontWeight.w800)),
                      subtitle: answer.note.isEmpty ? null : Text(answer.note, style: const TextStyle(color: RevEnginePalette.muted)),
