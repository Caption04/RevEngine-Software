...
class _SignatureScreenState extends State<SignatureScreen> {
  ...
  Future<Uint8List> _signaturePngBytes() async {
    ...
    if (boundary == null) throw const RevEngineApiException('Signature pad is not ready');
    final image = await boundary.toImage(pixelRatio: 3);
    final data = await image.toByteData(format: ui.ImageByteFormat.png);
    if (data == null) throw const RevEngineApiException('Could not export signature image');
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(widget.job.title, style: const TextStyle(color: RevEnginePalette.muted)),
                      ],
                    ),
                  ),
                ],
              ...
              PremiumCard(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        const PremiumIconTile(icon: Icons.draw_outlined, color: RevEnginePalette.primaryBright),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              const Text('Capture and upload a real signature image. Placeholder signature URLs are disabled.', style: TextStyle(color: RevEnginePalette.muted)),
                            ],
                          ),
                        ),
                      ],
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: <BoxShadow>[
                          BoxShadow(color: RevEnginePalette.primary.withValues(alpha: 0.16), blurRadius: 26, offset: const Offset(0, 12)),
                        ],
                      ),
                      child: ClipRRect(
                              ...
                              child: CustomPaint(
                                ...
                                child: Center(
                                  child: _points.isEmpty
                                      ? Text('Sign here', style: TextStyle(color: RevEnginePalette.midnight.withValues(alpha: 0.36), fontWeight: FontWeight.w700))
...
class _SignaturePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = RevEnginePalette.midnight
      ..strokeWidth = 3
